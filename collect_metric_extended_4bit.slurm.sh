...
#SBATCH --job-name=roof_4bit
#SBATCH --time=4:00:00
#SBATCH --gres=gpu:a100:1
#SBATCH -w notch347
#SBATCH --ntasks=1
#SBATCH --output=/uufs/chpc.utah.edu/common/home/u1323098/sundar-group-space2/ADEPT/FINAL_BENCHMARKING_SCRIPTS/roof_4bit%j.out
...
outputfolder=/uufs/chpc.utah.edu/common/home/u1323098/sundar-group-space2/ADEPT/BENCHMARKING_RESULTS/ROOFLINE/ADEPT_4bit_2
