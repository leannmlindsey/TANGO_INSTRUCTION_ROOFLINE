...
#SBATCH --job-name=roof_8bit_if
#SBATCH --time=4:00:00
#SBATCH --gres=gpu:a100:1
#SBATCH --ntasks=1
#SBATCH --output=/uufs/chpc.utah.edu/common/home/u1323098/sundar-group-space2/ADEPT/FINAL_BENCHMARKING_SCRIPTS/roof_8bit_if%j.out
...
outputfolder=/uufs/chpc.utah.edu/common/home/u1323098/sundar-group-space2/ADEPT/BENCHMARKING_RESULTS/ROOFLINE/ADEPT_8bit_if_2
